...
public class BoardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) 
		...
		if(cmd.equals("list")) {
			...
			reMap.put("msg","게시물 입력에 실패하였습니다.");
			if(result) {
				reMap.put("msg","게시물 입력에 성공하였습니다.");
			}
			...
			HashMap<String,String> reMap = new HashMap<String,String>();
			reMap.put("msg","게시물 삭제에 실패하였습니다.");
			if(result) {
				reMap.put("msg","게시물 삭제에 성공하였습니다.");
			}
			reMap.put("result", result+"");
			pw.write(gs.toJson(reMap));
			...
			HashMap<String,String> reMap = new HashMap<String,String>();
			reMap.put("msg","게시물 수정에 실패하였습니다.");
			if(result) {
				reMap.put("msg","게시물 수정에 성공하였습니다.");
			}
			reMap.put("result",result+"");
			pw.write(gs.toJson(reMap));
		}
